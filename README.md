...
wget -O data.zip "https://zenodo.org/records/19616358/files/data.zip?download=1"
unzip data.zip
```
...
```bash
# Navigate to the main DeepPlant directory
wget -O models.zip "https://zenodo.org/records/19616358/files/models.zip?download=1"
unzip models.zip
```
